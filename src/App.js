            ...
            <div className="list-books-content">
              <div>
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
          				{this.books.filter( (book) => book.shelf==="currentlyReading" ).map( (book) => (
                        <li>
                          <div className="book">
                ...
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
          				{this.books.filter( (book) => book.shelf==="wantToRead" ).map( (book) => (
                        <li>
                          <div className="book">
                            <div className="book-top">
                              <div className="book-cover" style={{ width: 128, height: 193, backgroundImage: book.image }}></div>
                              <BookShelfChanger shelf="wantToRead"/>
                            </div>
                            <div className="book-title">{book.title}</div>
                            <div className="book-authors">{book.authors.join()}</div>
                          </div>
                ...
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
          				{this.books.filter( (book) => book.shelf==="read" ).map( (book) => (
                        <li>
                          <div className="book">
                            <div className="book-top">
                              <div className="book-cover" style={{ width: 128, height: 193, backgroundImage: book.image }}></div>
                              <BookShelfChanger shelf="read"/>
                            </div>
                            <div className="book-title">{book.title}</div>
                            <div className="book-authors">{book.authors.join()}</div>
                          </div>
